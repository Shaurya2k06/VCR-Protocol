...
export default function PolicyBuilder() {
  ...
  const buildBody = () => ({
    ...
    constraints: {
      maxTransaction: {
        amount: maxAmount.trim(),
        token: token.trim(),
        chain: chain.trim(),
      },
      dailyLimit: {
        amount: dailyAmount.trim(),
        token: token.trim(),
        chain: chain.trim(),
      },
      ...
      timeRestrictions:
        startHour !== "" && endHour !== ""
          ? {
              timezone: "UTC",
              allowedHours: [parseInt(startHour, 10), parseInt(endHour, 10)],
            }
          : undefined,
    },
    metadata: {
    ...
    ...(setENS && ensName.trim() && agentIdNum.trim()
      ? {
          ensName: ensName.trim(),
          agentIdNumber: parseInt(agentIdNum, 10),
          setENS: true,
        }
      : {}),
  });
  ...
  const canProceedFromAgentStep = agentId.trim() && createdBy.trim();
  const canProceedFromConstraintsStep =
    maxAmount.trim() &&
    dailyAmount.trim() &&
    token.trim() &&
    chain.trim() &&
    ...
    endHour !== "";
  const canPublish =
    canProceedFromAgentStep &&
    canProceedFromConstraintsStep &&
    (!setENS || (ensName.trim() && agentIdNum.trim()));
    ...
    <div className="page">
      <div className="container">
        <div className="page-header">
          ...
          <p>
            Define spending constraints for your agent, pin to IPFS, and anchor
            via ENS
          </p>
        </div>
        ...
        <div className="grid-2">
          ...
          <div>
            {step === 0 && (
              <div className="card">
                <div className="card-header">
                  ...
                  <p>The fully-qualified ERC-8004 agent ID</p>
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="Enter the real fully-qualified agent ID"
                  />
                  <p
                    style={{
                      fontSize: "0.78rem",
                ...
                <div className="form-group">
                  <label className="form-label">
                    Created By (owner address)
                  </label>
                  <input
                    className="form-input mono"
                    value={createdBy}
                    onChange={(e) => setCreatedBy(e.target.value)}
                    placeholder="Enter the real owner wallet address"
                  />
                </div>
                <div className="form-group">
                  <label className="form-label">
                ...
                <button
                  ...
                  onClick={() => setStep(1)}
                  disabled={!canProceedFromAgentStep}
                >
                  Next: Constraints →
                </button>
              </div>
            ...
            {step === 1 && (
              <div className="card">
                <div className="card-header">
                  <h2>Spending Constraints</h2>
                  <p>Define what the agent is allowed to spend</p>
                </div>

                <div className="form-row">
                  <div className="form-group">
                    <label className="form-label">
                      Max per-tx (base units)
                    </label>
                    <input
                      className="form-input mono"
                      value={maxAmount}
                ...
                <div className="form-group">
                  <label className="form-label">
                    Allowed Recipients (comma-separated addresses)
                  </label>
                  <textarea
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button
                    ...
                    style={{ flex: 1 }}
                    onClick={() => setStep(2)}
                    disabled={!canProceedFromConstraintsStep}
                  >
                    Next: ENS & Publish →
                  </button>
                </div>
            ...
            {step === 2 && (
              <div className="card">
                <div className="card-header">
                  <h2>ENS & Publish</h2>
                  <p>Pin to IPFS and optionally set ENS records</p>
                </div>
                ...
                >
                  <p
                    style={{ fontSize: "0.82rem", color: "var(--neon-amber)" }}
                  >
                    ⚠ The signing wallet (PRIVATE_KEY in server .env) will
                    submit all ENS transactions on Sepolia.
                  </p>
                </div>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        placeholder="Enter the real ENS name linked to this agent"
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        type="number"
                        value={agentIdNum}
                        onChange={(e) => setAgentIdNum(e.target.value)}
                        placeholder="0"
                      />
                    </div>
                  </div>
            ...
            {step === 3 && result && (
              <div className="card">
                <div className="card-header">
                  ...
                  <p>Successfully pinned and anchored</p>
                </div>
                ...
                <div className="form-group">
                  ...
                  <div
                    ...
                    style={{ padding: "10px 14px", wordBreak: "break-all" }}
                  >
                    {result.ipfsUri}
                  </div>
                </div>
